...
/**
 * Redirect target for the eGov SSO callback (auth/callback).
 *
 ...
 * instead of continuing the in-flight sign-in. Bouncing back to the login
 * screen there is harmless because the native session was already resolved
 * by the OS-level interception.
 *
 ...
 * to the opener tab. Without that call the opener hangs forever.
 */
