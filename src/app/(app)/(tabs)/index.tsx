...
const SERVICE_TILES: ServiceTileDef[] = [
  { key: 'find-care', label: 'Find Care', icon: 'medical-outline', subtitle: 'Search doctors, clinics, and specialists near you.' },
  { key: 'facilities', label: 'Facilities', icon: 'business-outline', subtitle: 'Browse hospitals and health centers.' },
  { key: 'appointments', label: 'Appointments', icon: 'calendar-outline', subtitle: 'Book and manage your appointments.' },
  { key: 'health-id', label: 'Health ID', icon: 'id-card-outline', subtitle: 'View your Digital Health ID and QR code.' },
  { key: 'nearby', label: 'Nearby', icon: 'location-outline', subtitle: 'Find healthcare services close to you.' },
  { key: 'journey', label: 'Journey', icon: 'map-outline', subtitle: 'Track your healthcare journey and history.' },
];
    ...
    <View style={styles.header}>
      ...
      <View style={styles.headerActions}>
        <Pressable
          ...
          <Ionicons name="notifications-outline" size={20} color={AuthColors.text} />
      ...
      <SafeAreaView style={styles.safeArea}>
        {healthProfile ? (
          <ScrollView
              ...
              <View style={styles.servicesGrid}>
                {SERVICE_TILES.map((tile) => (
                  <Pressable
                    ...
                    <Ionicons name={tile.icon} size={26} color={AuthColors.primary} />
            ...
            <Pressable
              ...
              <View style={styles.aiTextBlock}>
                ...
                <Text style={styles.aiSubtitle}>How can we help you today?</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color={AuthColors.textSecondary} />
            </Pressable>
          ...
          <View style={styles.heroSection}>
            <Text style={[styles.title, { color: AuthColors.text }]}>Welcome to AGAPAY</Text>
            <Text style={[styles.subtitle, { color: AuthColors.textSecondary }]}>
